package org.distributed.frontenddistributed.search;
...
import org.distributed.frontenddistributed.cluster.ServiceRegistry;
import org.distributed.frontenddistributed.model.frontend.FrontendSearchRequest;
import org.distributed.frontenddistributed.model.frontend.FrontendSearchResponse;
import org.distributed.frontenddistributed.model.proto.SearchModel;
import org.distributed.frontenddistributed.networking.OnRequestCallback;
import org.distributed.frontenddistributed.networking.WebClient;
...
public class UserSearchHandler implements OnRequestCallback {
    ...
    private FrontendSearchResponse createFrontendResponse(FrontendSearchRequest frontendSearchRequest) throws IOException {
    ...
    private SearchModel.Response sendRequestToSearchCluster(String searchQuery) throws IOException {
        ...
        try {
            ...
            byte[] payloadBody = (byte[]) client.sendTask(coordinatorAddress, searchRequest.toByteArray()).join();
